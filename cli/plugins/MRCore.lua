...
if data[tostring(msg.to.id)]['filterlist'][(word)] then
   if not lang then
         return "*Ɯσяɗ* [`"..word.."`] *ιѕ αƖяєαɗу fιƖтєяєɗ*️"
            else
         return "*کلمه* [`"..word.."`] *از قبل فیلتر بود*️"
    end
end
...
local function delmsg (MaTaDoR,MahDiRoO)
    ...
    for k,v in pairs(Arashwm.messages_) do
        ...
        if msgs == 1 then
            tdcli.deleteMessages(Arashwm.messages_[0].chat_id_,{[0] = MahDiRoO.messages_[0].id_}, dl_cb, cmd)
            return false
        end
    end
    tdcli.getChatHistory(Arashwm.messages_[0].chat_id_, MahDiRoO.messages_[0].id_,0 , 100, delmsg, {msgs=msgs})
end
----------------------------------------
...
if not lang then
return "*>Ɛяяσя*\n`Iѕ AƖяєαɗу AƖƖ Uѕєя SιƖєηт` ️" 
elseif lang then
return "*>انجام نشد*\n`تمامی کاربران از قبل در حالت سکوت بودن` ️"
end
else 
...
if not lang then
 return "*>Lιηк* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ` ️"
elseif lang then
...
if not lang then
 return "*>Lιηк* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود لینک در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lιηк* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` "
elseif lang then
 return "اخراج لینک در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lιηк* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` "
elseif lang then
 return "اخطار لینک در گروه هم اکنون فعال است "
end
else
...
if not lang then
 return "*Tag* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ` "
elseif lang then
...
if not lang then
 return "*>Tag* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود تگ در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Tag* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج تگ در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Tag* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار تگ در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*username* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ` "
elseif lang then
 return "ارسال نام کاربری در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>username* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود نام کاربری در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>username* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج نام کاربری در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>username* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار نام کاربری در گروه هم اکنون فعال است ️"
end
else
...
elseif lang then
 return "ارسال فراخوانی افراد هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Mєηтιση* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود فراخوانی افراد در گروه هم اکنون فعال است "
end
else
...
if not lang then
 return "*>Mєηтιση* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج فراخوانی افراد در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Mєηтιση* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار فراخوانی افراد در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Aяαвιc/Ƥєяѕιαη* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود کلمات عربی/فارسی در گروه هم اکنون فعال است "
end
else
...
if not lang then
 return "*>Aяαвιc/Ƥєяѕιαη* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج کلمات عربی/فارسی در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Aяαвιc/Ƥєяѕιαη* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` "
elseif lang then
 return "اخطار کلمات عربی/فارسی در گروه هم اکنون فعال است ️"
end
else
...
elseif lang then
 return "ارسال کلمات انگلیسی در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>english* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود کلمات انگلیسی در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>english* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج کلمات انگلیسی در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>english* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار کلمات انگلیسی در گروه هم اکنون فعال است "
end
else
...
elseif lang then
 return "ویرایش پیام هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Ɛɗιтιηg* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود ویرایش پیام در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Ɛɗιтιηg* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج ویرایش پیام در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Ɛɗιтιηg* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار ویرایش پیام در گروه هم اکنون فعال است ️"
end
else
...
elseif lang then
 return "ارسال پیام مکرر در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Ɓσтѕ* `Ƥяσтєcтιση Iѕ AƖяєαɗу ƐηαвƖєɗ` "
elseif lang then
 return "محافظت از گروه در برابر ربات ها هم اکنون فعال است  ️"
end
else
...
elseif lang then
 return "ورود به گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then 
 return "*>Mαякɗσωη* `Ƥσѕтιηg Iѕ AƖяєαɗу Lσcкєɗ` "
elseif lang then
 return "ارسال پیام های دارای فونت در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Mαякɗσωη* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود پیام های دارای فونت در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Mαякɗσωη* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج پیام های دارای فونت در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Mαякɗσωη* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار پیام های دارای فونت در گروه هم اکنون فعال است "
end
else
...
elseif lang then
 return "ارسال صفحات وب در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Ɯєвραgє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود صفحات وب در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Ɯєвραgє* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج صفحات وب در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Ɯєвραgє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار صفحات وب در گروه هم اکنون فعال است "
end
else
...
if not lang then
 return "*>Ƥιηηєɗ Mєѕѕαgє* `Iѕ AƖяєαɗу Lσcкєɗ` ️"
elseif lang then
 return "سنجاق کردن پیام در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠιf* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن تصاویر متحرک فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠιf* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` "
elseif lang then
 return "مسدود تصاویر متحرک در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠιf* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج تصاویر متحرک در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠιf* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار تصاویر متحرک در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠαмє* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن بازی های تحت وب فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠαмє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود بازی های تحت وب در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠαмє* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج بازی های تحت وب در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ɠαмє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار بازی های تحت وب در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк IηƖιηє* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "قفل اینلاین فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк IηƖιηє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود کیبورد شیشه ای در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк IηƖιηє* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج اینلاین در گروه فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк IηƖιηє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار اینلاین در گروه هم اکنون فعال است ️"
end
else
...
elseif lang then
return "بیصدا  اینلاین غیر فعال است  ️"
end
else 
...
if not lang then
 return "*>Lσcк Ƭєxт* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن متن فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Ƭєxт* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود متن در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƭєxт* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج متن در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƭєxт* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار متن در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƥнσтσ* `Iѕ AƖяєαɗу ƐηαвƖєɗ` "
elseif lang then
 return "بیصدا کردن عکس فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Ƥнσтσ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود عکس در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƥнσтσ* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج عکس در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƥнσтσ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار عکس در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ʋιɗєσ* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن فیلم فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Ʋιɗєσ Ѕεlғ* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن فیلم سلف فعال است  ️"
end
else
...
elseif lang then
return "بیصدا کردن فیلم سلف غیرفعال است  ️"
end
else 
...
if not lang then
 return "*>Lσcк Ʋιɗєσ Ѕεlғ* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` "
elseif lang then
 return "اخراج فیلم سلف در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ʋιɗєσ Ѕεlғ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` "
elseif lang then
 return "اخطار فیلم سلف در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ʋιɗєσ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود فیلم در گروه هم اکنون فعال است ️"
end
else
...
if mute_video_kick == 'kick' then
if not lang then
 return "*>Lσcк Ʋιɗєσ* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج فیلم در گروه هم اکنون ممنوع است ️"
end
else
...
if mute_video_warn == 'warn' then
if not lang then
 return "*>Lσcк Ʋιɗєσ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار فیلم در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Aυɗισ* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن آهنگ فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Aυɗισ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود آهنگ در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Aυɗισ* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج + در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Aυɗισ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار آهنگ در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ʋσιcє* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن صدا فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Ʋσιcє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود صدا در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>+* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج صدا در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ʋσιcє* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار صدا در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Sтιcкєя* `Iѕ AƖяєαɗу ƐηαвƖєɗ`️"
elseif lang then
 return "بیصدا کردن برچسب فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Sticker* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود برچسب در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Sticker* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` "
elseif lang then
 return "اخراج برچسب در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Sticker* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار برچسب در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƈσηтαcт* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن مخاطب فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Ƈσηтαcт* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود مخاطب در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƈσηтαcт* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج مخاطب در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƈσηтαcт* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار مخاطب در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƒσяωαяɗ* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
...
if not lang then
 return "*>Lσcк Ƒσяωαяɗ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود نقل قول در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƒσяωαяɗ* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج نقل قول در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƒσяωαяɗ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار نقل قول در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Lσcαтιση* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
 return "بیصدا کردن موقعیت فعال است  ️"
end
else
...
if not lang then
 return "*>Lσcк Lσcαтιση* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود موقعیت در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Lσcαтιση* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج موقعیت در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Lσcαтιση* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار موقعیت در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Dᴏᴄᴜᴍᴇɴᴛ* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
...
if not lang then
 return "*>Lσcк Dᴏᴄᴜᴍᴇɴᴛ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود اسناد در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Dᴏᴄᴜᴍᴇɴᴛ* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج اسناد در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Dᴏᴄᴜᴍᴇɴᴛ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار اسناد در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк ƬgSєяνιcє* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
...
if not lang then
 return "*>Lσcк Ƙєувσαяɗ* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ️"
elseif lang then
...
if not lang then
 return "*>Lσcк Ƙєувσαяɗ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɓαηιηg` ️"
elseif lang then
 return "مسدود صفحه کلید در گروه هم اکنون فعال است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƙєувσαяɗ* `Ƥσѕтιηg Iѕ AƖяєαɗу кιcкιηg` ️"
elseif lang then
 return "اخراج صفحه کلید در گروه هم اکنون ممنوع است ️"
end
else
...
if not lang then
 return "*>Lσcк Ƙєувσαяɗ* `Ƥσѕтιηg Iѕ AƖяєαɗу Ɯαяηιηg` ️"
elseif lang then
 return "اخطار صفحه کلید در گروه هم اکنون فعال است ️"
end
else
...
if ((matches[1]:lower() == "add" ) or (matches[1] == 'اد' )) and is_sudo(msg) then
...
redis:set(hash, true)
return "*زبــان گــروه تــنـظـیم شـد بـه : فــارسی🇮🇷*"
end
end
...
if not lang then
 ...
 if ((matches[1]:lower() == 'muteall' ) or (matches[1] == 'موقعیت' )) and ((matches[2]:lower() == 'status' ) or (matches[2] == 'بیصدا' )) and is_mod(msg) then
      ...
      local mute_time = redis:ttl(hash)
		...
		return '_بیصدا بودن گروه غیر فعال است    ️._'
		end
		else
		if not lang then
...
if ((matches[1]:lower() == "dev" ) or (matches[1] == "برنامه نویس" )) and is_mahdiroo(msg) then 
      tdcli.sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 989015858478, 'arashwm', 'lashai', 205549111)
end
--------------------------------
...
if not lang then
return "*PonG jonam💜* `>["..(msg.from.username or ':|').."]<`"
   else
return "*💜جـــونـــم * `>["..(msg.from.username or ':|').."]<`" 
   end
end
--------------------- Welcome -----------------------
